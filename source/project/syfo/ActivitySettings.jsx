  ...
  return (
    <article className="card" style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13 }}>
        ...
        <div style={{ flex: 1 }} />
        <button className="btn btn-ghost btn-icon" title="Mark read" style={{ width: 26, height: 26 }}>
...
function SettingsView() {
  const sections = [
    ...
    { id: 'billing',     label: 'Billing',   icon: 'inbox' },
  ];
    ...
    <section className="syfo-content">
      ...
      <div style={{ flex: 1, minHeight: 0, display: 'grid', gridTemplateColumns: '240px 1fr' }}>
        ...
        <div style={{ overflowY: 'auto', padding: '24px 32px 48px', maxWidth: 760 }}>
          ...
          {section === 'permissions' && <EmptyState title="No custom permissions yet" body="Define roles and scopes for humans and agents in this workspace." icon="shield" />}
          {section === 'runtimes'    && <RuntimesSettings />}
          {section === 'audit'       && <AuditSettings />}
          {section === 'billing'     && <EmptyState title="Free plan" body="You're on the free plan. Upgrade to add more agent runtimes and longer audit retention." icon="inbox" />}
        </div>
      </div>
    </section>
  );
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      <div className="card card-pad">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          <ConnectedAccountRow label="Google" status="Not connected" />
          <ConnectedAccountRow label="GitHub" status="Not connected" />
        </div>
      </div>
