...
const HUMANS = [
  { id: 'tonyren',  name: 'tonyren',  handle: '@tonyren',  presence: 'online',  role: 'Owner', kind: 'human', isYou: true },
  { id: 'jiang',    name: '姜浩文',    handle: '@jianghw',  presence: 'online',  role: 'Member', kind: 'human' },
  { id: 'rene',     name: 'René',     handle: '@rene',     presence: 'offline', role: 'Member', kind: 'human' },
];
...
const ACTIVITY = [
  { id: 'a1', actorId: 'lisa',    verb: 'deployed', object: 'thehot · v0.51.1',           ts: '2m ago',  kind: 'deploy'   },
  { id: 'a2', actorId: 'tio',     verb: 'merged',   object: 'PR #318 → main',             ts: '8m ago',  kind: 'git'      },
  { id: 'a3', actorId: 'rennie',  verb: 'restarted',object: 'breeze-cobra-99 · daemon',   ts: '11m ago', kind: 'system'   },
  { id: 'a4', actorId: 'tonyren', verb: 'opened',   object: 'task #142',                  ts: '21m ago', kind: 'task'     },
  { id: 'a5', actorId: 'asuna',   verb: 'completed',object: 'task #4 · config review',    ts: '34m ago', kind: 'task'     },
  { id: 'a6', actorId: 'jim',     verb: 'approved', object: 'M-filter A/B plan',          ts: '1h ago',  kind: 'approval' },
...
const AGENT_SKILLS = ['Bash', 'Python', 'Git', 'Read code', 'Edit code', 'Run tests', 'Deploy'];
