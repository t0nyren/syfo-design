...
MANUAL_CODE_TRANSLATIONS = {
    ...
    "@Daily-Briefing 你好！每天早上 9 点，帮我整理前一天 #general 频道的讨论摘要，发到这里，格式：\n1. 重要决定（如果有）\n2. 待跟进事项\n3. 今日重点\n\n从明天开始执行。": "@Daily-Briefing hello. Every morning at 9, please summarize the previous day's discussion in #general and post it here in this format:\n1. Important decisions, if any\n2. Follow-up items\n3. Today's focus\n\nStart tomorrow.",
...
TRANSLATION_TEXT_REPLACEMENTS = {
    ...
    "en": (
        ...
        ("the team's all-human+Agent channel", "the team's shared Channel for everyone"),
