...
MANUAL_CODE_TRANSLATIONS = {
    ...
    "@Ringo 帮我查一下昨天 #product 频道里讨论的决定": "@Ringo help me check the decisions discussed yesterday in #product",
    "@Ringo 帮我起草下周的产品周报": "@Ringo help me draft next week's product weekly report",
    "@Ringo 整理一下本周 #product 频道的所有决定，发到 #summary": "@Ringo summarize all decisions from #product this week and post them to #summary",
    "@Ringo 整理这个频道里本周客户提到的产品问题，按 P1/P2/P3 分类，并给出建议动作。": "@Ringo summarize the product issues customers mentioned in this channel this week, classify them by P1/P2/P3, and suggest next actions.",
    "@Ringo 每天早上 9 点，把昨天 #dev 频道的讨论整理成简报发到这里。": "@Ringo every morning at 9, summarize yesterday's discussion in #dev and post the briefing here.",
    "@Ringo 每天早上 9 点，把昨日 #dev 频道的讨论整理成简报发到这里": "@Ringo every morning at 9, summarize yesterday's discussion in #dev and post the briefing here",
...
TRANSLATION_TEXT_REPLACEMENTS = {
    ...
    "en": (
        ...
        ("the team's all-human+Agent channel", "the team's default public Channel. To involve an Agent, manually add it as a member in channel settings"),
        ("the team's default public channel", "the team's default public Channel. To involve an Agent, manually add it as a member in channel settings"),
