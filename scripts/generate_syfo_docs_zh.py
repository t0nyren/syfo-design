...
MANUAL_TEXT_TRANSLATIONS.setdefault("en", {}).update({
    ...
    "步骤一：选择运行位置": "Step 1: Choose Where to Run",
    "步骤二：配置 Agent": "Step 2: Configure the Agent",
    ...
    "怎么查看一个 Agent 已经有哪些 Skill？": "How do I see what Skills an Agent already has?",
    "MCP 连接在哪里创建和管理？": "Where do I create and manage MCP connections?",
...
TRANSLATION_TEXT_REPLACEMENTS = {
    ...
    "en": (
        ...
        ("inference strength", "reasoning effort"),
        ("Reasoning strength", "Reasoning effort"),
