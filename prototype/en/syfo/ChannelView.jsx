...
function ChannelView({ channelId }) {
  ...
  const tabs = [
    ...
    { id: 'tasks',    label: 'Tasks',    icon: 'list-todo', count: TASKS.length },
      ...
      <div style={{ maxWidth: 980, margin: '0 auto', display: 'flex', flexDirection: 'column',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          ...
          <div style={{ display: 'flex', gap: 2 }}>
            ...
            <Button variant="ghost" icon title="Attach file"><Icon name="paperclip" size={14} /></Button>
            <Button variant="ghost" icon title="Attach image"><Icon name="image" size={14} /></Button>
            <Button variant="ghost" icon title="Command"><Icon name="command" size={14} /></Button>
          </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
          <thead>
            <tr style={{ background: 'var(--bg-paper)' }}>
              {['Name','Type','Size','Uploaded by','When'].map(h => (
                <th key={h} style={{
